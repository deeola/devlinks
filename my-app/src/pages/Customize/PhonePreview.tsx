...
// import dp from "../../assets/images/icon-email.svg";
// import "./PhonePreview.css";
// import { linkArray } from "../../linkArray";
// import arrow from "../../assets/images/icon-arrow-right.svg";
// import { SBody } from "../../components/Text/Text";
...
//   const arr = [
//     { color: "#000000", image: gitlab, text: "Gitlab" },
//     { color: "#4C4C4C", image: facebook, text: "Facebook" },
//     { color: "#818181", image: x, text: "X" },
//     { color: "#000000", image: gitlab, text: "Gitlab" },
//     { color: "#4C4C4C", image: facebook, text: "Facebook" },
//      { color: "#000000", image: gitlab, text: "Gitlab" }
//   ];
...
//             <image x="0" y="0" width="100%" height="100%" xlinkHref={dp} />
//           </pattern>
//         </defs>

//         <circle cx="153.5" cy="112" r="48" fill="url(#image)" />
...
export default function PhonePreview() {
  ...
  const name = "Praise Bamigboye"
  const email = "benwright@gmail.com"
