...
export default function PhonePreview() {
  ...
  let email: string | boolean = "benwright@gmail.com"
  let isImage: string | boolean = bwImage
      ...
      >
        ...
        {/* <defs>
          <pattern id="image" x="0" y="0" width="100%" height="100%">
            <image x="0" y="0" width="100%" height="100%" xlinkHref={bwImage} />
          </pattern>
        </defs> */}
        {
            !isImage ?   <circle cx="153.5" cy="112" r="48" fill="#EEE" /> : <foreignObject x="100" y="64" width="100" height="100" className="rounded-image-foreign">
            <div className="rounded-image-container">
              <img src={bwImage} alt="Profile" className="rounded-image" />
            </div>
          </foreignObject>
        }
        ...
        {
            !name  ?  <rect width="160" height="16" x="73.5" y="185" fill="#EEE" rx="8" /> : <foreignObject x="0" y="180" className="nameEmailForeignObject">
            <MBody className="textFONAME"  text={name} />
          </foreignObject>
        }

        {
            !email ? <rect width="160" height="16" x="73.5" y="207" fill="#EEE" rx="8" /> :  <foreignObject x="0" y="220" className="nameEmailForeignObject">
