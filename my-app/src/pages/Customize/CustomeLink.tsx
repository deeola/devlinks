  ...
  return (
    <div className="customelinkcontainer">
      ...
      <div className="add-new-link">
        <Button onClick={handleDisplayForm} buttonType='secondary' text="+ Add new link" />
      </div>
      {!addlink ? <div className="link-middle">
      ...
      </div> : <AddLink  placeholder='https://www.github.com/benwright' number={1} dropArray={linkArray} />  }
